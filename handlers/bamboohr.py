...
async def handle_bamboohr_application(page, applicant_data, company, job_id):
    try:
        # Build the job URL dynamically
        job_url = f"https://{company}.bamboohr.com/jobs/view.php?id={job_id}"
...
async def main():
    ...
    async with async_playwright() as p:
        ...
        for job in job_list:
            await handle_bamboohr_application(page, applicant_data, job["company"], job["job_id"])
